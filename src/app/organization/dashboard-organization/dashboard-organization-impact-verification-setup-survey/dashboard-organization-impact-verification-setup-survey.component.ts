...
@Component({
  selector: 'app-dashboard-organization-impact-verification-setup-survey',
  templateUrl:
    './dashboard-organization-impact-verification-setup-survey.component.html',
  styleUrls: [
    './dashboard-organization-impact-verification-setup-survey.component.scss',
  ],
})
export class DashboardOrganizationImpactVerificationSetupSurveyComponent {
  questions: Question[] = [
    {
      type: 'optionBased',
      title: '',
  ...
  selectQuestion(index: number): void {
    ...
    document
      .getElementById(`question_box_${index}`)
  ...
  nextPreviewQuestion() {
    ...
    document
      .getElementById(`question_box_${this.activeQuestionIndex}`)
      ?.scrollIntoView({ behavior: 'smooth' });
  }
}
