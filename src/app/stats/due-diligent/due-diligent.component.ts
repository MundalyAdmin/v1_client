...
@Component({
  selector: 'app-due-diligent',
  templateUrl: './due-diligent.component.html',
  styleUrls: ['./due-diligent.component.scss']
})
export class DueDiligentComponent implements OnInit {
  data: any;
  ...
  ngOnInit() {
    ...
    this.data = {
        labels: ['High Risk', 'Medium', 'C'],
        datasets: [
            {
                data: [300, 50, 100],
                backgroundColor: [documentStyle.getPropertyValue('--blue-500'), documentStyle.getPropertyValue('--blue-200'), documentStyle.getPropertyValue('--blue-700')],
                hoverBackgroundColor: [documentStyle.getPropertyValue('--blue-400'), documentStyle.getPropertyValue('--blue-100'), documentStyle.getPropertyValue('--blue-600')]
            }
        ]
    };
